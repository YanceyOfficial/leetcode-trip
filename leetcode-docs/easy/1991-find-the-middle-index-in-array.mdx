...
This problem is essentially the same as [LeetCode 724 - Find Pivot Index](/leetcode/easy/724-find-pivot-index). The only difference is the problem statement wording - both ask to find an index where the sum of elements on the left equals the sum of elements on the right.
