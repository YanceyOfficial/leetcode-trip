...
>
  <img src={useBaseUrl(`/img/560-subarray-sum-1.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-2.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-3.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-4.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-5.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-6.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-7.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-8.png`)} />
  <img src={useBaseUrl(`/img/560-subarray-sum-9.png`)} />
</Carousel>
